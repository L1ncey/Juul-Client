...
public class CFont extends CustomFontRenderer {
    ...
    protected DynamicTextureWrapper setupTexture(Font font, boolean antiAlias, boolean fractionalMetrics, CharData[] chars) {
        BufferedImage img = this.generateFontImage(font, antiAlias, fractionalMetrics, chars);
        try {
            return new DynamicTextureWrapper(img);
        }
        catch (Exception e) {
            e.printStackTrace();
        }
